...
jQuery(document).ready(function() {
	...
	if(pageName.indexOf('resolver') > -1) {
		...
		// Test to see if we can create our own link to the Renewal/My Loans page
			...
			setTimeout(function() {
				if(jQuery('span.limiter:contains("Catalog Only")')) {searchParams
